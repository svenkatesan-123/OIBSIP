...
on.style.background="radial-gradient(circle,rgb(65, 6, 6),rgb(71, 14, 14),white)";
on.style.color="red";
...
const statuscheck=()=>{
    let display = document.getElementById("display");
     if(check==0){
        check=1;
        on.style.background="radial-gradient(circle,red,rgb(2, 14, 14))";
        ...
        for(let i=0;i<12;i++){
            ...
            button2[i].style.boxShadow="3px 3px rgb(100, 80,1)";
        }
        for(let i=0;i<5;i++){
